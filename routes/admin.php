...
Route::group(['middleware'=>'Owner'] , function(){
    ...
    Route::get('export_pdf' , 'UserController@export_pdf')->name('users.pdf');
    // Route::get('/export_pdf/user_id/{user_id}/test_id/{test_id}' , 'UserController@export_pdf')->name('users.pdf');
