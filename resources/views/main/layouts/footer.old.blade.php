    ...
    <div class="container">
        ...
        <div class="row">
            <div class="footer-auxilary">
                <div class="col-sm-6" style="position: absolute; bottom:1px; font-size: 20px">
                    <a href="/lang/ar" <?php   if (app()->getLocale() == 'ar') echo ' style="font-weight: bolder" ' ?>>Arabic</a>|
                    <a <?php   if (app()->getLocale() == 'en') echo 'style="font-weight: bolder"' ?> href="/lang/en">English</a>
                </div>
            </div>
        </div>
