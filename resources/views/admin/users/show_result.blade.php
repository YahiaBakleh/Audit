            ...
            <div class="search-content">
                ...
                <div class="search-toolbar">
                    <ul class="list-unstyled nav nav-pills">
                        <li class="active">
                            <a href="/admin/export_pdf/user_id/{{$user->id}}/test_id/{{$testId}}" data-toggle="tab">Result</a>
                        </li>
                    </ul>
                </div>
               <div class="row p-b-20">
                    ...
                    <div class="col-md-2 pull-right">
                        <a class="no-style-a" href="{{route('users.pdf')}}?user_id={{$user->id}}&test_id={{$testId}}">
                                    ...
                                    <a href="pages-invoice.html" class="has-thumb">
                                        <div class="result-thumb" style="width:100px;">
                                            @if($q_image = $question->image_path)
                                                <img src="{{ asset('storage/' . $q_image) }}" alt="Invoice" height="{{$question->height !=null ? $question->height : 0 }}px" width="{{ $question->width !=null ? $question->width : 0}}px">
                                            @else
                                            ...
                                            <div class="checkbox-custom checkbox-primary">
                                                <div class="row">
                                                    ...
                                                    @if($path = $choice->image_path)
                                                            ...
                                                            <div class="col-sm-4">
                                                            <img class="img-thumbnail" src="{{ asset('storage/'.$path) }}" alt="Invoice" width="{{ $choice->width !=null ? $choice->width:0}}px" height="{{ $choice->height !=null ? $choice->height:0}}px">
                                                            </div>
                                                        @endif
                                                        </div>
                                                    </div>
