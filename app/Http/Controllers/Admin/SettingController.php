...
class SettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('customizedlogo')) {
            $input['customizedlogo'] = $request->file('customizedlogo')->store('basics', 'public');

            @unlink(storage_path('app/public/' . $settings->customizedlogo));
        }
